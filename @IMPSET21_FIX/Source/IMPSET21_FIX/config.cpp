...
class CfgPatches
{
	class IMPSET21_FIX
	{
		units[] = {"IMP_Bag_SET21_FIX","IMP_Balaclava_SET21_FIX","IMP_Belt_SET21_FIX","IMP_Boots_SET21_FIX","IMP_Helmet_SET21_FIX","IMP_Jacket_SET21_1_FIX","IMP_Pants_SET21_1_FIX","IMP_Vest_SET21_1_FIX","IMP_SET21_Pouch_Blue_FIX"};
		weapons[] = {};
		requiredVersion = 0.1;
...
class CfgVehicles
{
	...
	class IMP_Belt_SET21_FIX : IMP_Belt_SET21
	{
		...
		// В оригинале у Belt вообще не было GlobalArmor - добавляем целиком
		class DamageSystem
		{
			class GlobalHealth
			{
	...
	class IMP_SET21_Pouch_Blue_FIX : IMP_SET21_Pouch_Blue
	{
		...
		// В оригинале у Pouch вообще не было GlobalArmor - добавляем целиком
		class DamageSystem
		{
			class GlobalHealth
			{
